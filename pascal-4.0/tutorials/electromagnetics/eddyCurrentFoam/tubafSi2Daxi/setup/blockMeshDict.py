...
def bset(i, vi, **kwargs):

    kv = 101

    d.blocks.set(i, vi + [kv + i for i in vi], **kwargs)

bset(  0, [  0,  1,  2,  3], zone="solid")
bset(  1, [  1,  4,  5,  2], zone="solid")
bset(  2, [  3,  2,  5,  6], zone="solid")
bset(  3, [  4,  7,  8,  9], zone="fluid")
bset(  4, [  5,  4,  9, 10], zone="fluid")
bset(  5, [  6,  5, 10, 11], zone="fluid")
bset(  6, [ 12, 13,  1,  0], zone="vessel")
bset(  7, [ 13, 14,  4,  1], zone="vessel")
bset(  8, [ 14, 15,  7,  4], zone="vessel")
bset(  9, [  7, 15, 16,  8], zone="vessel")
bset( 10, [ 17, 18, 13, 12], zone="heater")
bset( 11, [ 18, 19, 14, 13], zone="heater")
bset( 12, [ 19, 20, 15, 14], zone="heater")
bset( 13, [ 20, 21, 22, 15], zone="heater")
bset( 14, [ 15, 22, 23, 16], zone="heater")
bset( 15, [ 16, 23, 24, 25], zone="heater") # Heater or Space?
bset( 16, [  8, 16, 25, 26], zone="space")
bset( 17, [  9,  8, 26, 27], zone="space")
bset( 18, [ 10,  9, 27, 28], zone="space")
bset( 19, [ 11, 10, 28, 29], zone="space")
bset( 20, [ 30, 31, 18, 17], zone="space")
bset( 21, [ 31, 32, 19, 18], zone="space")
bset( 22, [ 32, 33, 20, 19], zone="space")
bset( 23, [ 33, 34, 21, 20], zone="space")
bset( 24, [ 34, 35, 36, 21], zone="space")
bset( 25, [ 21, 36, 37, 22], zone="space")
bset( 26, [ 22, 37, 38, 23], zone="space")
bset( 27, [ 23, 38, 39, 24], zone="space")
bset( 28, [ 24, 39, 40, 41], zone="space")
bset( 29, [ 25, 24, 41, 42], zone="space")
bset( 30, [ 26, 25, 42, 43], zone="space")
bset( 31, [ 27, 26, 43, 44], zone="space")
bset( 32, [ 28, 27, 44, 45], zone="space")
bset( 33, [ 29, 28, 45, 46], zone="space")
...
if d.subDict("boundary"):
    ...
    if d.boundarySubDict("front", "patch"):

        d.boundaryFaces.write()

    if d.boundarySubDict("back", "patch"):
