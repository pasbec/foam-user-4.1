...
#   include "createTime.H"
    ...
    if(faMeshBoundaryIOobj.headerOk())
    {
        ...
        PtrList<edgeVectorField> edgeVectorFields;
        readFields(aMesh, objects, edgeVectorFields);
        ...
        for (label procI = 0; procI < mesh.nProcs(); procI++)
        {
            ...
            )
            {
                ...
                fieldDecomposer.decomposeFields(edgeVectorFields);
            }
        }
    }
